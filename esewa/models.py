...
# from django.utils.translation import ngettext as _, npgettext, ngettext_lazy
# from django.utils.translation import gettext_lazy as _,gettext_lazy,ungettext
...
class Subscription(models.Model):
    name = models.CharField(max_length=100,choices=PLAN)
    ...
    def get_pricing_display(self):
        if not self.price:
            ...
            return ngettext('%(price).02f / %(unit)s',
...
class Transaction(models.Model):
    ...
    user = models.ForeignKey(auth.models.User,on_delete=models.CASCADE,
                             null=True, blank=True, editable=False)
    ipn = models.ForeignKey(eSewa,on_delete=models.CASCADE,
                            null=True, blank=True, editable=False)
